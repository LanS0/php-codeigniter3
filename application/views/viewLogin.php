                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php echo form_open('ViewController/checkLogin'); ?>
                                    <!-- <form  action="<?=base_url("/ViewController/checkLogin")?>" method="POST"> -->
                                        <div class="form-group">
                                            <input placeholder="Email atau Username" type="username" name="email" class="form-control form-control-user"
                                    ...
                                    <!-- </form> -->
                                    <div class="text-center">
                                        <a class="small" href="<?=site_url("/ViewController/register")?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
